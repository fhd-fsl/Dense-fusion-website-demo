...
const steps = [
  {
    title: "Analyze",
    label: "STEP 01",
    desc: "Evaluate your workloads, applications, and system performance to identify optimization opportunities.",
  },
  {
    title: "Optimize",
    label: "STEP 02",
    desc: "Fine-tune operating systems, libraries, AI frameworks, and software components for maximum efficiency.",
  },
  {
    title: "Validate",
    label: "STEP 03",
    desc: "Benchmark performance improvements and verify system stability across real-world workloads.",
  },
  {
    title: "Monitor",
    label: "STEP 04",
    desc: "Continuously monitor, optimize, and support your software environment to ensure consistent performance and scalability.",
  },
];
        ...
        <ScrollReveal>
          <div className="mb-16 md:mb-24 max-w-3xl">
            ...
            <p className="text-gray-400 text-lg md:text-xl max-w-2xl">
              A structured approach to optimizing your software stack for peak performance.
            </p>
          </div>
        </ScrollReveal>
