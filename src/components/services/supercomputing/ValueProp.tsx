      ...
      <div className="mx-auto max-w-[1100px] w-full px-6 md:px-12 text-center">
        ...
        <ScrollReveal>
          <h2 className="text-[32px] md:text-[48px] font-semibold text-black leading-[1.25] mb-16 max-w-4xl mx-auto">
            DenseFusion provides strategic HPC consulting to help organizations{" "}
            ...
            design, optimize and scale high-performance computing{" "}
            ...
            environments for maximum performance, efficiency{" "}
