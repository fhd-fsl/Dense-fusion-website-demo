        ...
        <ScrollReveal>
          <div className="text-center mb-16 md:mb-24">
            ...
            <p className="text-gray-500 text-lg md:text-xl max-w-2xl mx-auto">
              Empowering organizations with scalable AI workflows, optimized GPU computing,
              and high-performance infrastructure for next-generation applications.
            </p>
          </div>
        </ScrollReveal>
          ...
          <div className="flex flex-col gap-6">
            <ScrollReveal delay={0.1}>
              <div className="bg-white p-8 md:p-10 rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.03)] h-full flex flex-col justify-between min-h-[220px] md:min-h-[260px]">
                ...
                <p className="text-gray-600 text-base md:text-lg mt-8">
                  Train AI models across multiple GPUs for faster, scalable performance.
                </p>
              </div>
            </ScrollReveal>
            <ScrollReveal delay={0.2}>
              <div className="bg-white p-8 md:p-10 rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.03)] h-full flex flex-col justify-between min-h-[220px] md:min-h-[260px]">
                ...
                <p className="text-gray-600 text-base md:text-lg mt-8">
                  Process text, images, video, audio, and sensor data in unified AI workflows.
                </p>
              </div>
            </ScrollReveal>
          </div>
            ...
            <ScrollReveal delay={0.3} className="h-full">
              <div className="bg-gradient-to-br from-[#006D40] to-[#6DC27F] p-8 md:p-10 rounded-xl shadow-lg h-full flex flex-col justify-between min-h-[220px] md:min-h-[464px]">
                ...
                <p className="text-green-50 text-base md:text-lg mt-8">
                  Build generative AI applications for automation and intelligent content creation.
                </p>
              </div>
            </ScrollReveal>
          </div>
          ...
          <div className="flex flex-col gap-6">
            <ScrollReveal delay={0.4}>
              <div className="bg-white p-8 md:p-10 rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.03)] h-full flex flex-col justify-between min-h-[220px] md:min-h-[260px]">
                ...
                <p className="text-gray-600 text-base md:text-lg mt-8">
                  Deploy and optimize enterprise-ready large language models.
                </p>
              </div>
            </ScrollReveal>
            <ScrollReveal delay={0.5}>
              <div className="bg-white p-8 md:p-10 rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.03)] h-full flex flex-col justify-between min-h-[220px] md:min-h-[260px]">
                ...
                <p className="text-gray-600 text-base md:text-lg mt-8">
                  Optimize GPU resources for maximum speed, efficiency, and scalability.
                </p>
              </div>
            </ScrollReveal>
          </div>
