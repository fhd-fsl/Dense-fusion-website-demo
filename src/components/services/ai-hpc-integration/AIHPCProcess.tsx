...
const steps = [
  {
    title: "Assess",
    label: "STEP 01",
    desc: "Analyze your workloads, performance goals, and infrastructure requirements to identify the best HPC solution.",
  },
  {
    title: "Design",
    label: "STEP 02",
    desc: "Develop a scalable HPC architecture with the right compute, storage, networking, and GPU resources.",
  },
  {
    title: "Deploy",
    label: "STEP 03",
  ...
  },
  {
    title: "Optimize",
    label: "STEP 04",
    desc: "Continuously monitor, fine-tune, and support your environment to maximize efficiency and long-term reliability.",
  },
];
        ...
        <ScrollReveal>
          <div className="mb-16 md:mb-24 max-w-3xl">
            ...
            <p className="text-gray-400 text-lg md:text-xl max-w-2xl">
              From planning to optimization, we deliver reliable HPC infrastructure at every stage.
            </p>
          </div>
        </ScrollReveal>
