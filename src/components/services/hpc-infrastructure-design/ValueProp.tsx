      ...
      <div className="mx-auto max-w-[1100px] w-full px-6 md:px-12 text-center">
        ...
        <ScrollReveal>
          <h2 className="text-[32px] md:text-[48px] font-semibold text-black leading-[1.25] mb-16 max-w-4xl mx-auto">
            We build custom HPC environments optimized for performance, scalability{" "}
            ...
            and reliability across on-premises, cloud, and hybrid deployments{" "}
            ...
            enabling organizations to meet demanding computational{" "}
