      ...
      <div className="mx-auto max-w-[1300px] w-full px-6 md:px-12 relative z-10 text-center">
        <ScrollReveal>
          ...
          <p className="text-green-50 text-lg md:text-xl max-w-3xl mx-auto mb-10 leading-relaxed">
            Design high-performance computing environments optimized for AI, simulation, analytics, and data-intensive applications with expert guidance from DenseFusion.
          </p>
