...
const challenges = [
  ...
  },
  {
    ...
    icon: (
      <Image
        src="/assets/industries/government/Bolt-Fill Streamline Sharp-Fill-Streamline-Material-Free.svg"
        alt="Bolt"
        width={48}
        height={48}
        className="w-12 h-12 object-contain transition-all duration-300 group-hover:brightness-0 group-hover:invert"
  ...
  },
  {
    ...
    desc: "Deploy AI and machine learning models for demanding government applications.",
    icon: (
      <Image
  ...
  },
  {
    ...
    icon: (
      <Image
        src="/assets/industries/government/Server Streamline Font-Awesome.svg"
        alt="Server"
        width={48}
        height={48}
        className="w-12 h-12 object-contain transition-all duration-300 group-hover:brightness-0 group-hover:invert"
        ...
        <ScrollReveal>
          <div className="mb-16">
            ...
            <h2 className="text-[32px] md:text-[48px] font-medium leading-[1.2] tracking-tight max-w-5xl text-black">
              Modern government operations depend on large datasets, real-time intelligence, and complex computational workloads. Organizations require secure, scalable computing environments for quick and reliable information processing.
            </h2>
          </div>
        </ScrollReveal>
