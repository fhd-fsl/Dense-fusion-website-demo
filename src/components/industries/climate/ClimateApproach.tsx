...
const steps = [
  {
    title: "Discover",
    label: "STEP 01",
    desc: "Understand your datasets, models, workloads, and research objectives.",
  },
  {
    title: "Design",
    label: "STEP 02",
    desc: "Create an optimized AI and HPC environment for your requirements.",
  },
  {
    title: "Deploy",
    label: "STEP 03",
    desc: "Implement and integrate the computing environment.",
  },
  {
    title: "Optimize",
    label: "STEP 04",
    desc: "Continuously improve performance, efficiency, and time to results.",
  },
];

export default function ClimateApproach() {
        ...
        <ScrollReveal>
          <div className="mb-16 md:mb-24 max-w-3xl">
            ...
            <p className="text-gray-400 text-lg md:text-xl leading-relaxed">
              From Climate Challenges to High-Performance Solutions
            </p>
          </div>
        </ScrollReveal>
                ...
                >
                  ...
                  <div
                    className={`absolute left-0 top-2 w-[20px] h-[20px] rounded-full border-4 border-[#0a0a0a] transition-all duration-500 z-10 ${
                      activeIndex >= index ? "bg-[#6DC27F]" : "bg-gray-700"
                    } ${
                      activeIndex === index
                        ? "shadow-[0_0_12px_2px_rgba(109,194,127,0.8)] scale-110"
                        : ""
                    }`}
                  ></div>
                  ...
                  {index !== steps.length - 1 && (
                    <div className="absolute left-[9px] top-[26px] -bottom-[10px] w-[2px] bg-gray-800 z-0 hidden md:block">
                      <div
                        className="w-full bg-[#6DC27F] transition-all duration-500"
