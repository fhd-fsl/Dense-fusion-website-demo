...
const challenges = [
  ...
  },
  {
    ...
    desc: "Deploy AI and machine learning models for demanding defense applications.",
    icon: (
      <Image
        ...
        <ScrollReveal>
          <div className="mb-16">
            ...
            <h2 className="text-[32px] md:text-[48px] font-medium leading-[1.2] tracking-tight max-w-5xl text-black">
              Modern defense operations depend on large datasets, real-time intelligence, and complex computational workloads. Organizations require secure, scalable computing environments for quick and reliable information processing.
            </h2>
          </div>
        </ScrollReveal>
