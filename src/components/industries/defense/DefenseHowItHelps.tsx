...
export default function DefenseHowItHelps() {
  return (
        ...
        <ScrollReveal>
          <div className="text-center mb-16 md:mb-24 max-w-4xl mx-auto">
            ...
            <p className="text-gray-600 text-lg md:text-xl leading-relaxed">
              We design and optimize computing environments around the unique requirements of defense organizations, combining advanced AI capabilities with high-performance infrastructure.
            </p>
          </div>
        </ScrollReveal>
