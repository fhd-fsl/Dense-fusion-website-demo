...
const steps = [
  ...
  },
  {
    title: "Design",
    label: "STEP 02",
    desc: "Develop an AI and HPC solution tailored to your specific defense use cases.",
  },
  {
    title: "Deploy",
    label: "STEP 03",
...
export default function DefenseApproach() {
        ...
        <ScrollReveal>
          <div className="mb-16 md:mb-24 max-w-3xl">
            ...
            <p className="text-gray-400 text-lg md:text-xl leading-relaxed">
              From Defense Challenges to High-Performance Solutions
            </p>
          </div>
        </ScrollReveal>
