          ...
          <div className="w-full lg:w-1/2 max-w-2xl">
            <ScrollReveal delay={0.2}>
              ...
              <p className="text-[#5D5D5D] text-lg md:text-xl leading-relaxed mb-8 max-w-2xl">
                DenseFusion combines AI and high-performance computing to help defense organizations process complex data, accelerate intelligence, and support faster, more informed decisions.
              </p>
