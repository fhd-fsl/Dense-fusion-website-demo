      ...
      <div className="mx-auto max-w-4xl px-6 md:px-12">
        <ScrollReveal>
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-secondaryBlack mb-8 tracking-tight">
            From Satellite Imagery to Environmental Intelligence
          </h2>
          <p className="text-gray-500 text-lg md:text-xl leading-relaxed">
            Serena Green uses satellite-based analysis to help organizations track forests, vegetation, and environmental change over time - making complex data easier to visualize and compare.
          </p>
        </ScrollReveal>
      </div>
    </section>
