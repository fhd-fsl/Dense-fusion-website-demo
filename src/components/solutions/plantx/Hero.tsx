          ...
          <div className="w-full lg:w-1/2">
            <ScrollReveal>
              <div className="inline-flex items-center rounded-full border border-gray-200 bg-white px-5 py-2 mb-6 shadow-sm">
                <span className="text-xl md:text-2xl font-bold bg-gradient-to-r from-[#006D40] to-[#6DC27F] bg-clip-text text-transparent tracking-wide">PlantX</span>
              </div>
              
              <h1 className="text-4xl md:text-5xl lg:text-[56px] font-bold text-secondaryBlack mb-6 tracking-tight leading-[1.1]">
                AI-Powered Geospatial Intelligence for Urban & Land Monitoring
              </h1>

              <p className="text-gray-500 text-lg md:text-xl leading-relaxed mb-10 max-w-xl">
                PlantX combines satellite imagery, GIS, and advanced analytics to 
                monitor land-cover changes, urban growth, and environmental 
          ...
          <div className="w-full lg:w-1/2">
            <ScrollReveal delay={0.2}>
              <div className="relative w-full aspect-[4/3] rounded-xl overflow-hidden shadow-2xl">
                <Image 
                  src="/assets/solutions/PlantX Map Graphic.svg"
                  alt="PlantX Hero Graphic"
                  fill
